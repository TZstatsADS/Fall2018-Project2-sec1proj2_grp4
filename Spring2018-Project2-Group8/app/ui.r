packages.used=c("shiny", "plotly", "shinydashboard", "leaflet", "shinythemes")
...
navbarPage(title = "Hospital Finder",
    ...
    navbarMenu("Hospital Recommendation",
      ...
      selectInput("DRG", label = "DRG", choices = c(levels(iips_data$DRG.Definition), "Select"), selected = "Select"),
      sliderInput("cost", label = "Budget", min = 2000, max = 20000, value = 20000),
      selectInput("EM", label ="EM", choices = c("Select","Yes", "No"), selected = "Select"),
